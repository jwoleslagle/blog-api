...
// we're going to add some BlogPosts to BlogPosts
// so there's some data to look at
BlogPosts.create(
    'Feeling happy', 'Today I am feeling happy - oh so happy!', 'Rando Blogsman');
BlogPosts.create(
    'Feeling sad', 'Today I am feeling sad - so so very sad.', 'Rando Blogsman');
